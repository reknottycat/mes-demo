...
- First integration: manual QR bind and a simulated gateway. No program download or real OPC UA connection in P0.
...
4. External signals are idempotent by source command/event id.
